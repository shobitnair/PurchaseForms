...
export const PDFsp101 = (data) => {
    ...
    doc.setFont('times','normal')
    doc.text(data.name+`, `+data.department,97,23,{align:'left'})
    doc.line(pageWidth-19, 24, 19, 24)
    
    doc.setFont('times','bold')
    doc.text(`Budget Head & Sanctioned Budget: `,21,27.5,{align:'left'})
    doc.setFont('times','normal')
    doc.text(data.budgetHead+`, `+data.budgetSanction,97,27.5,{align:'left'})
    ...
    doc.setFont('times','normal')
    doc.text(data.GEM+'',97,87,{align:'left'})
    ...
    doc.setFont('times','normal')
    doc.text(data.MOE+'',97,106,{align:'left'})
    ...
    doc.setFont('times','normal')
    doc.text(data.NOQ+'',97,111,{align:'left'})
    ...
    doc.setFont("times",'normal')
    doc.text(data.RMP+'',73,ypos,{align:'left'})
    ypos+=15
    doc.setFont("times",'bold')
    doc.text("Delivery Period:",21,ypos,{align:'left'})
    doc.setFont("times",'normal')
    doc.text(data.DP+'',47,ypos,{align:'left'})
    ypos+=15
    doc.setFont("times",'bold')
